...
カード画像は「Card_ID_English_Name.拡張子」の形式に統一する。
...
* カバー画像は `デッキID_cover.拡張子` とする。
* GitHubの画像リポジトリは、アプリで表示する画像の公開保管場所として使用する。
* 原本画像はGoogle Driveなどで別途保管する。
